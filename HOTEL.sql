...
TYP_POKOJU_ID NUMBER(1) PRIMARY KEY check (typ_pokoju_id>0),
...
KLASA_POKOJU_ID NUMBER(1) PRIMARY KEY check (klasa_pokoju_id>0),
...
CENA_POKOJU_ID NUMBER(2) PRIMARY KEY check (cena_pokoju_id>0),
